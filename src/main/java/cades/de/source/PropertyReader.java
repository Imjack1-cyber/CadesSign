...
public class PropertyReader {
    ...
    private static Properties getProperties() {
        ...
        if (prop == null) {
            LOG.debug("Properties not loaded yet. Attempting to load from file.");
            prop = new Properties();
            LOG.debug("Attempting to load properties from 'app.config' in classpath.");
    ...
    public static String getProperty(String propertyKey) {
        LOG.debug("Retrieving property value for key: " + propertyKey);
        String value = getProperties().getProperty(propertyKey);
        LOG.debug("Retrieved property value for key '{}': '{}'", propertyKey, value);
    ...
    public static int getIntProperty(String propertyKey) {
        LOG.debug("Retrieving integer property value for key: " + propertyKey);
